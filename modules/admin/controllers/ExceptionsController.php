...
use app\models\search\ExceptionsSearch;
...
class ExceptionsController extends Controller
{
    ...
    {
        $searchModel = new ExceptionsSearch();
    ...
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException(Yii::t('app/exceptions', 'The requested page does not exist.'));
    }
}
