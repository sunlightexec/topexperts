...
//            print_r($fileop);fclose($handle);die();
            ...
            $model->old_description = $fileop[2];
            $model->description = $fileop[3];
            $model->spreadsheet = $fileop[4];
            $model->count_ratings = $fileop[5];
            $model->grading_ratings = $fileop[6];
            $model->paid_ratings = $fileop[7];
            $model->address = [
                'facebook' => $fileop[8],
                'twitter' => $fileop[9],
                'youtube' => $fileop[10],
