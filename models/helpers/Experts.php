...
//        print_r($updates);die();
        ...
        if(!empty($updatesFlip) || !empty($updatesHold)) {
            $model->flip = $updatesFlip['flipCount']==0 ? 0 : round($updatesFlip['flipSum'] / $updatesFlip['flipCount'],2);
            $model->hold = $updatesHold['holdCount']==0 ? 0 : round($updatesHold['holdSum'] / $updatesHold['holdCount'],2);
            $model->save();
        } else {
            $model->flip = 0;
            $model->hold = 0;
